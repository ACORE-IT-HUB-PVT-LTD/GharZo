  ...
  return (
   ...
   <div className="min-h-screen flex items-center justify-center bg-white px-4">
    <div className="relative w-full max-w-5xl h-[650px] bg-slate-900 rounded-3xl shadow-2xl overflow-hidden flex">
      ...
      {/* UI UPDATED: LEFT SIDE - Dark sidebar with form */}
      <div className="w-full lg:w-[45%] bg-gradient-to-b from-[#0c2344] to-[#0b4f91] relative overflow-hidden flex items-center justify-center p-6 sm:p-8">
        {/* UI UPDATED: Subtle gradient overlay */}
        <div className="absolute inset-0 bg-gradient-to-br from-cyan-500/5 via-transparent to-blue-500/5"></div>
        
        {/* UI UPDATED: Animated particles background */}
        <Particles
          id="tsparticles"
          init={particlesInit}
          options={{
        ...
        >
          ...
          >
            ...
            <div>
              <h2 className="text-3xl sm:text-4xl font-bold text-white mb-2">
                {!otpSent ? "Welcome back User" : "Verify OTP"}
              </h2>
              <p className="text-slate-400 text-sm">
                {!otpSent ? (
                  <>
                    New user?{" "}
                    <button
                      onClick={() => navigate("/signupuser", { state: { mobile: phone, from } })}
          ...
          {/* UI UPDATED: Form content with step transitions */}
          <AnimatePresence mode="wait">
            {!otpSent ? (
              // UI UPDATED: Phone input step
              <motion.div
                key="phone"
              ...
              // UI UPDATED: OTP verification step
              <motion.div
                key="otp"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
      ...
      {/* UI UPDATED: RIGHT SIDE - Beautiful image background */}
      <motion.div
      ...
      >
        {/* UI UPDATED: Background image with overlay */}
        <div
        ...
        >
          {/* UI UPDATED: Gradient overlay for depth and text readability */}
        ...
        <div className="relative h-full flex flex-col justify-end p-12 z-10">
          ...
          {/* UI UPDATED: Decorative elements */}
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ delay: 0.6 }}
        ...
        {/* UI UPDATED: Floating expand button (decorative) */}
        <motion.button
