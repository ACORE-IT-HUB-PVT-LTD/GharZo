...
const PropertyList = () => {
  ...
  return (
    <div className="px-2 py-4 md:px-20 min-h-screen text-white bg-white">
      {/* Filter Bar */}
      <div
        ...
        <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
          {filteredProperties.map((property) => (
            <motion.div
              ...
              className="bg-gradient-to-b from-blue-100 to-green-100 shadow-xl rounded-2xl overflow-hidden flex flex-col border border-green-400"
            >
              ...
              <div className="p-4 flex flex-col gap-2 text-sm text-black">
                ...
                <p className="flex items-center text-green-700">
                  ...
                  {/* <FaCouch className="ml-4 mr-2 animate-spin-slow" />
                  {property.furnished ? "Furnished" : "Unfurnished"} */}
                </p>
                <p className="text-gray-600">Type: {property.type}</p>
                <div className="mt-3 flex gap-2">
                  <Link
                    to={`/organization/property-detail/${property._id}`}
                  ...
                  <Link
                    to={`/organization/edit-property/${property._id}`}
