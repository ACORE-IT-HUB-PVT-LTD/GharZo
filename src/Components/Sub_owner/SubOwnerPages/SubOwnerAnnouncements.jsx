...
const SubOwnerAnnouncements = () => {
  ...
  const getToken = () => localStorage.getItem('subOwnerToken') || '';
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">Sub Owner Management System</p>
              </div>
            </div>
          </div>
        </div>
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-xs text-slate-400">
                          <div className="flex items-center gap-2">
                            ...
                            {announcement.stats?.totalRecipients || 0} recipients
                          </div>
                          <div className="flex items-center gap-2">
                            <Eye className="w-4 h-4 text-orange-400" />
                            {announcement.stats?.totalReads || 0} reads
                          </div>
...
export default SubOwnerAnnouncements;
