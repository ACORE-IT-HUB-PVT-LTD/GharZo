...
export default function PropertyPage() {
  ...
  // =========== DUMMY DATA FETCH - REPLACE REAL API ===========
  useEffect(() => {
      ...
      try {
        ...
        const dummyAccommodations = [
          ...
          },
          {
            ...
            roomName: "Deluxe 2BHK",
            rentAmount: 35000,
            securityDeposit: 105000,
            moveInDate: "2024-03-01",
            landlordId: "LANDLORD002",
            tenantId: "TENANT123",
            amenities: ["WiFi", "Parking", "Gym", "Clubhouse"],
            status: "Active",
            area: 1100,
            isFavorite: true,
          },
          {
            ...
            propertyAddress: "789 Marine Drive",
            propertyCity: "Chennai",
            roomName: "Executive Suite 1201",
            rentAmount: 42000,
            securityDeposit: 126000,
            moveInDate: "2024-02-10",
            landlordId: "LANDLORD003",
            tenantId: "TENANT123",
        ...
        const dummyRooms = [
          {
            ...
            rentAmount: 12000,
            area: 250,
            amenities: ["Attached Bath", "Balcony", "Wardrobe"],
            propertyId: "PROP001",
          },
          {
            roomId: "ROOM002",
            ...
            rentAmount: 8000,
            area: 180,
            amenities: ["Shared Bath", "Study Table"],
            propertyId: "PROP001",
          },
          {
            roomId: "ROOM003",
            ...
            rentAmount: 15000,
            area: 450,
            amenities: ["Attached Bath", "Kitchenette", "Balcony"],
            propertyId: "PROP003",
          },
        ];
        ...
        // Set tenant ID from dummy data
        const dummyTenantId = dummyAccommodations[0]?.tenantId;
        if (dummyTenantId) {
          localStorage.setItem("tenantId", dummyTenantId);
        }

        // Initialize favorite properties from dummy data
        const initialFavorites = dummyAccommodations
          .filter((prop) => prop.isFavorite)
          .map((prop) => prop.propertyId);
        setFavoriteProperties(initialFavorites);
    ...
    */
    ...
    // Option 1: Use dummy data (for development/testing)
    fetchDummyData();

    // Option 2: Use real API (for production)
    // fetchData();
          ...
          <div className="flex flex-col bg-white px-10 rounded shadow-md py-3 lg:flex-row lg:items-center justify-between  gap-6 mb-8">
            <div className="">
              ...
              <p className="text-gray-600 mt-2">
                Manage your accommodations and rooms with ease
              </p>
            </div>
          </div>
